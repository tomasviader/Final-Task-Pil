...
import com.example.FinalPil.controller.ReportController;
...
class ReportServiceTest {
    ...
    void aNewReportShouldBeCreated() throws Exception {
        ...
        when(service.saveReport(report)).thenReturn(report);
    ...
    void weShouldGetAllReports() throws Exception {
        ...
        Mockito.when(service.getReports()).thenReturn(records);
    ...
    public void weShouldGetAReportById() throws Exception {
        ...
        Mockito.when(service.getReportById(report.getId())).thenReturn(report);
    ...
    void aReportShouldBeModified() throws Exception {
        ...
        Mockito.when(service.getReportById(report.getId())).thenReturn(report);
        Mockito.when(service.modifyReport(reportUpdated.getId(), reportUpdated)).thenReturn(reportUpdated);
