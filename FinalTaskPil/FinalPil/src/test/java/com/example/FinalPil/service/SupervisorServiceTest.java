...
class SupervisorServiceTest {
    ...
    void aNewSupervisorShouldBeCreated() throws Exception {
        ...
        when(service.saveSupervisor(supervisor)).thenReturn(supervisor);
    ...
    void aSupervisorShouldBeModified() throws Exception {
        ...
        Mockito.when(service.getSupervisorById(supervisor.getId())).thenReturn(supervisor);
        Mockito.when(service.modifySupervisor(updatedSupervisor.getId(),updatedSupervisor)).thenReturn(updatedSupervisor);
    ...
    void weShouldGetAllSupervisors() throws Exception {
        ...
        Mockito.when(service.getSupervisors()).thenReturn(records);
    ...
    void weShouldGetASupervisorById() throws Exception {
        ...
        Mockito.when(service.getSupervisorById(supervisor1.getId())).thenReturn(supervisor1);
